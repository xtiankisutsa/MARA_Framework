...
MARA Framework is developed and maintained by [@xtian_kisutsa](https://twitter.com/xtian_kisutsa) and [@iamckn](https://twitter.com/iamckn). MARA is in its very early stages of develpment and a lot still needs to be done. Feel free to contribute to the project. Any suggestions, recommendations, corrections, or additions are welcome and will be highly appreciated. 
